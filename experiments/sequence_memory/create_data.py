...
v.create()
v.save('results/sequence_memory/gt/sparse_100_128_10.pth')


# create sequence
for l in range(10,110,10):
    g = Generator(vocab_path='results/sequence_memory/gt/sparse_100_128_10.pth', vocab_len=10, len_seq=l, num_seq=1, num_datasets=3)
    g.create()
