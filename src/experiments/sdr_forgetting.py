...
from src.data.binary import generate_multiple_correlated_SDR_patterns
...
def compute(N, P, model, bs, specs, seed=1):
    ...
    for b in bs:
        ...
        X = generate_multiple_correlated_SDR_patterns(num_seqs=10, P=P, N=N, b=b, S=specs['S'], seed=seed)
...
if __name__ == "__main__":
    ...
    args = dict( models=models, bs=bs, P=conf['P'], N=conf['N'], specs=specs)
